...
void testUpdatePriorities(const string &pqType) {
    ...
    cout << "Testing updatePriorities(): " << pqType << endl;
...
void testPriorityQueue(Eecs281PQ<int> *pq, const string &pqType) {
    cout << "Testing testPriorityQueue(): " << pqType << endl;
...
void testDtor(vector<int> & vec){
    Eecs281PQ<int> * pq = new PairingPQ<int>(vec.begin(), vec.end());
    //vector = {0, 1}
    pq->push(2);
...
void testRangedPush(const string &pqType){
    cout << "Testing Ranged Push: " << pqType << endl;
    ...
    /*if (pqType == "Unordered") {
        pq = new UnorderedPQ<int>(vec.begin(), vec.end());
    } // if
    else if (pqType == "Sorted"){
        pq = new SortedPQ<int>(vec.begin(), vec.end());
    }
    else if (pqType == "Binary"){
        pq = new BinaryPQ<int>(vec.begin(), vec.end());
    }
    else if (pqType == "Pairing"){
        pq = new PairingPQ<int>(vec.begin(), vec.end());
    }*/
    ...
    cout << "\ttestRangedPush() succeeded!" << endl;
